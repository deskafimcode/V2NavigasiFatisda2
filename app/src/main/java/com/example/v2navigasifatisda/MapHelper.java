...
public class MapHelper {
    ...
    public static MapGraph FMIPAFATISDA() {
        ...
        Node AA = new Node("Ruang B321 FMIPA",R.drawable.b321);
        Node AB = new Node("Ruang B320 FMIPA",R.drawable.b320);
        Node AC = new Node("Ruang B319 FMIPA",R.drawable.b319);
        Node AD = new Node("Lift Lantai 3 Gedung B FMIPA",R.drawable.lift_lt3);
        Node AE = new Node("Ruang B318 FMIPA",R.drawable.b318);
        Node AF = new Node("Ruang Ketua dan Sekre Kimia FMIPA",R.drawable.ketua_dan_sekre_kimia);
        Node AG = new Node("Pertigaan WorkSpace Prodi Kimia");
        Node AH = new Node("Ruang B302 FMIPA",R.drawable.b302);
        Node AI = new Node("Ruang B303 FMIPA",R.drawable.b303);
        Node AJ = new Node("Ruang B304 FMIPA",R.drawable.b304);
        Node AK = new Node("Ruang B305 FMIPA",R.drawable.b305);
        Node AL = new Node("Ruang B306 FMIPA",R.drawable.b306);
        Node AM = new Node("Ruang B307 FMIPA",R.drawable.b307);
        Node AN = new Node("Ruang B308 FMIPA",R.drawable.b308);
        Node AO = new Node("Ruang B309 FMIPA",R.drawable.b309);
        Node AP = new Node("Tangga Samping Barat Lantai 3 Gedung B",R.drawable.tangga_samping_barat_lt3);
        Node AQ = new Node("Ruang Lab Geofisika B301 FMIPA");
        Node AR = new Node("Tangga Tengah Lantai 3 Gedung B",R.drawable.tangga_tengah_lt3);
        Node AS = new Node("Ruang Administrasi dan Kaprodi Kimia",R.drawable.ruang_admin_dan_kaprodi_kimia);
        Node AT = new Node("Ruang Pertemuan B316 FMIPA",R.drawable.ruang_pertemuan_b316);
        Node AU = new Node("Pertigaan Barat Lantai 3 FMIPA Gedung B",R.drawable.pertigaan_barat_lt3);
        Node AV = new Node("Ruang B313 FMIPA",R.drawable.b313);
        Node AW = new Node("Ruang B312 FMIPA",R.drawable.b312);
        Node AX = new Node("Ruang B311 FMIPA",R.drawable.b311);
        Node AY = new Node("Ruang B310 FMIPA",R.drawable.b310);
        Node AZ = new Node("Pertigaan Timur Lantai 3 FMIPA Gedung B",R.drawable.pertigaan_timur_lt3);
        Node BA = new Node("Ruang Administrasi S2 & S3 Kimia B326 FMIPA",R.drawable.admin_s2_s3_kimia);
        Node BB = new Node("Ruang B325 FMIPA",R.drawable.b325);
        Node BC = new Node("Ruang B324 FMIPA",R.drawable.b324);
        Node BD = new Node("Ruang B323 FMIPA",R.drawable.b323);
        Node BE = new Node("Ruang B322 FMIPA",R.drawable.b322);
        Node BF = new Node("Tangga Samping Timur Lantai 3 Gedung B",R.drawable.tangga_samping_timur_lt3);
        Node BG = new Node("Ruang B314 FMIPA",R.drawable.b314);
        ...
        Node EP = new Node("Tangga Samping Barat Lantai 1 Gedung B");
